...
namespace TicTacToeGame
{
    ...
    {
        public static PlayerForm form { set; get; }
        Game game; 
        String clientName;
        ...
        public void initGame(GameMode gameMode)
        {
            ...
            PlayerForm.form = this;
            Player playerA = Start.getLoadPlayer();
            Player playerB = new Player(PlayerType.CROSS);
            game = new Game(ref playerA,ref playerB, Difficulty.NORMAL, gameMode);
            Player tmp = Start.getLoadPlayer();
        ...
        {
            //new game with same game modes
            Game.current_game.playerA.score = 0;
            Game.current_game.playerB.score = 0;
            resetBoard();
        ...
        private void updateGameDescription()
        {
            ...
            lblCrossScore.Text = game.playerB.score.ToString();
            lblBallScore.Text = game.playerA.score.ToString();
            lblPlayerA.Text = game.playerA.name;
            lblPlayerB.Text = game.playerB.name;
        }
        ...
        {
            Game.current_game.saveGameScore();
            refreshGame();
